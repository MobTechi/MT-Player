...
object Popups {
    ...
    fun showPopupForPlaybackSpeed(
        ...
        PopupMenu(activity, view).apply {
            ...
            if (AppPreferences.getPrefsInstance().playbackSpeedMode != AppConstants.PLAYBACK_SPEED_ONE_ONLY) {
                menu.findItem(getSelectedPlaybackItem(AppPreferences.getPrefsInstance().latestPlaybackSpeed))
                    .setTitleColor(
