...
import com.mobtech.mtplayer.databinding.FragmentEqualizerBinding
import com.mobtech.mtplayer.extensions.afterMeasured
import com.mobtech.mtplayer.extensions.createCircularReveal
...
class EqualizerFragment : Fragment() {
    ...
    private fun finishSetupEqualizer(view: View) {
        ...
        AppPreferences.getPrefsInstance().savedEqualizerSettings?.let { savedEqualizerSettings ->
    ...
    private fun updateBandLevels(isPresetChanged: Boolean) {
        ...
        try {
            ...
            if (!isPresetChanged) {
                _eqFragmentBinding?.run {
                    AppPreferences.getPrefsInstance().savedEqualizerSettings?.let { eqSettings ->
    ...
    private fun closeEqualizerOnError() {
        ...
        AppPreferences.getPrefsInstance().isEqForced = false
