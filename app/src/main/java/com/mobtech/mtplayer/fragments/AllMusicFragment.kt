...
import com.mobtech.mtplayer.databinding.FragmentAllMusicBinding
import com.mobtech.mtplayer.databinding.MusicItemBinding
import com.mobtech.mtplayer.extensions.setTitleColor
import com.mobtech.mtplayer.extensions.toFormattedDate
...
class AllMusicFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    private var mSorting = AppPreferences.getPrefsInstance().allMusicSorting

    private var mAllMusic: List<Music>? = null

    private val sIsFastScrollerPopup get() = (mSorting == AppConstants.ASCENDING_SORTING || mSorting == AppConstants.DESCENDING_SORTING) && AppPreferences.getPrefsInstance().songsVisualization != AppConstants.FN
    ...
    private fun setMenuOnItemClickListener(menu: Menu) {
        ...
        _allMusicFragmentBinding?.searchToolbar?.setOnMenuItemClickListener {
            ...
            if (it.itemId == R.id.default_sorting || it.itemId == R.id.ascending_sorting
                ...
                AppPreferences.getPrefsInstance().allMusicSorting = mSorting
