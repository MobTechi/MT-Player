...
object AppConstants {
    ...
    val DEFAULT_ACTIVE_FRAGMENTS =
        listOf(SONGS_TAB, FOLDERS_TAB, SETTINGS_TAB)
    ...
    // Notification
    const val NOTIFICATION_CHANNEL_ID = "CHANNEL_PLAYBACK_SERVICE_MT_PLAYER"
    const val NOTIFICATION_CHANNEL_ERROR_ID = "CHANNEL_ERROR_MT_PLAYER"
